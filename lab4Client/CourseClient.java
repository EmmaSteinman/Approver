...
public class CourseClient {
  ...
  */
  ...
  public static void main(String arguments[]) throws Exception {
    ...
    client.invoke("POST", "CSCU9N6", "Computer Games Development");
    client.invoke("POST", "CSCU9N6", "Computer Games Development");
    client.invoke("GET", "CSCU9N6");
    client.invoke("GET", "MATU988");
    client.invoke("PUT", "CSCU9N6", "Games Development");
    client.invoke("PUT", "MATU988", "math class");
    client.invoke("DELETE", "CSCU9N6");
    client.invoke("DELETE", "MATU988");
    client.invoke("GET", "CSCU9N6");
    client.invoke("POST", "ABCD123", "RANDOM CLASS");
    client.invoke("GET", "ABCD123");
  }
